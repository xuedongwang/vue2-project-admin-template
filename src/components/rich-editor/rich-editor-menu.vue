<template>
  <div class="rich-editor-menu">
    <div class="rich-editor-menu-item disabled">
    ...
    <a-dropdown overlayClassName="rich-editor-menu-item-dropdown-three" :trigger="['click']">
      ...
      <a-menu slot="overlay">
        ...
        <a-menu-item @click="handleInsert('code-block')">
          <div class="dropdown-menu-item-inner">
            <div class="dropdown-menu-item-inner-left">
               <svg
                  xmlns="http://www.w3.org/2000/svg"
        ...
        <a-menu-item @click="handleInsert('LaTex')">
          <div class="dropdown-menu-item-inner">
            <div class="dropdown-menu-item-inner-left">
               <svg
                  xmlns="http://www.w3.org/2000/svg"
        ...
        <a-menu-item @click="handleInsert('signature')">
          <div class="dropdown-menu-item-inner">
            <div class="dropdown-menu-item-inner-left">
               <svg
                  xmlns="http://www.w3.org/2000/svg"
        ...
        <a-menu-item @click="handleInsert('divider')">
          <div class="dropdown-menu-item-inner">
            <div class="dropdown-menu-item-inner-left">
              <svg
                  xmlns="http://www.w3.org/2000/svg"
    ...
    <a-dropdown overlayClassName="rich-editor-menu-item-dropdown-four" :trigger="['click']">
      <div class="rich-editor-menu-item">
    ...
    <a-dropdown overlayClassName="rich-editor-menu-item-dropdown-four" :trigger="['click']">
      ...
      <a-menu slot="overlay">
        ...
        >
          ...
          <span class="text" :data-style="item.style.fontFamily" :style="item.style">{{ item.name }}</span>
        </a-menu-item>
      </a-menu>
    </a-dropdown>
    <a-dropdown overlayClassName="rich-editor-menu-item-dropdown-one" :trigger="['click']">
      <div class="rich-editor-menu-item">
    ...
    <a-dropdown overlayClassName="rich-editor-menu-item-drapdown-two" :trigger="['click']">
      <div class="rich-editor-menu-item">
        <div class="picker-color">
          ...
          <div class="current-color" :style="{background: `rgba(${fontColor.rgba.r},${fontColor.rgba.g},${fontColor.rgba.b},${fontColor.rgba.a})`}"></div>
        </div>
        <a-icon class="caret" type="caret-down" />
      </div>
      <a-menu slot="overlay">
    ...
    <a-dropdown overlayClassName="rich-editor-menu-item-drapdown-two" :trigger="['click']">
      <div class="rich-editor-menu-item">
        <div class="picker-color">
          ...
          <div class="current-color" :style="{background: `rgba(${bgColor.rgba.r},${bgColor.rgba.g},${bgColor.rgba.b},${bgColor.rgba.a})`}"></div>
        </div>
        <a-icon class="caret" type="caret-down" />
      </div>
      <a-menu slot="overlay">
        <a-menu-item class="rich-editor-menu-item-drapdown-two-item">
          <sketch-picker v-model="bgColor"></sketch-picker>
        </a-menu-item>
      </a-menu>
    </a-dropdown>
    <a-dropdown overlayClassName="rich-editor-menu-item-dropdown-one" :trigger="['click']">
      <div class="rich-editor-menu-item">
        <svg width="24px" v-if="textAlign==='left'" height="24px" viewBox="0 0 24 24" version="1.1">
        ...
        <svg width="24px" v-if="textAlign==='center'" height="24px" viewBox="0 0 24 24" version="1.1">
          ...
          <svg width="24px" v-if="textAlign==='right'" height="24px" viewBox="0 0 24 24" version="1.1">
          ...
          <svg width="24px" v-if="textAlign==='justify'" height="24px" viewBox="0 0 24 24" version="1.1">
...
export default {
  data () {
    return {
      ...
      titleType,
      fontFamily,
      currentTitleType: titleType.default,
      currentFontSize: fontSize.default,
  ...
  methods: {
    ...
    handleSetFontFamily (type) {
      ...
      console.log('set font family:', type);
    },
